...
#melbourne_shop_400_speech_response = "Invalid parameters: Attribute 'name' must be unique"
#melbourne_shop_400_api_response = {"error": {"message": "Attribute 'name' must be unique", "code": 400}}
melbourne_shop_500_speech_response = "Error: Could not create site"
